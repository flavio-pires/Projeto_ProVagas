    ...
    public class CandidatoRepository : ICandidatoRepository
    {
        ...
        public void Atualizar(int id, Candidato candidatoAtualizado)
        {
            ...
            if (candidatoBuscado != null)
            {
                ...
                if (candidatoAtualizado.Habilidades != null)
                {
                    candidatoBuscado.Habilidades = candidatoAtualizado.Habilidades;
                }
                ...
                if (candidatoAtualizado.Atividades != null)
                {
                    candidatoBuscado.Atividades = candidatoAtualizado.Atividades;
                }
