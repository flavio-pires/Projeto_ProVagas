...
namespace Api.Provagas.Contexts
{
    public partial class ProVagasContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-MK0J0423\\SQLEXPRESS; Initial Catalog=ProVagas; Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Administrador>(entity =>
            {
                entity.HasKey(e => e.IdAdministrador)
                    .HasName("PK__Administ__2B3E34A8FE8602A1");

                entity.ToTable("Administrador");

                entity.HasIndex(e => e.Nif, "UQ__Administ__C7DEC3304E34335B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Beneficio>(entity =>
            {
                entity.HasKey(e => e.IdBeneficio)
                    .HasName("PK__Benefici__14B7CA0CA576CE62");
            ...
            modelBuilder.Entity<BeneficioXvaga>(entity =>
            {
                entity.HasKey(e => e.IdBeneficioVaga)
                    .HasName("PK__Benefici__44F955EBF2B59102");
                ...
                entity.HasOne(d => d.IdBeneficioNavigation)
                    ...
                    .HasConstraintName("FK__Beneficio__IdBen__70DDC3D8");

                entity.HasOne(d => d.IdVagaNavigation)
                    .WithMany(p => p.BeneficioXvagas)
                    .HasForeignKey(d => d.IdVaga)
                    .HasConstraintName("FK__Beneficio__IdVag__71D1E811");
            });

            modelBuilder.Entity<Candidato>(entity =>
            {
                entity.HasKey(e => e.IdCandidato)
                    .HasName("PK__Candidat__D559890524B33064");

                entity.ToTable("Candidato");

                entity.HasIndex(e => e.Cpf, "UQ__Candidat__C1F89731A56AA734")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdEnderecoNavigation)
                    ...
                    .HasConstraintName("FK__Candidato__IdEnd__4316F928");

                entity.HasOne(d => d.IdNivelEscolaridadeNavigation)
                    .WithMany(p => p.Candidatos)
                    .HasForeignKey(d => d.IdNivelEscolaridade)
                    .HasConstraintName("FK__Candidato__IdNiv__440B1D61");
            });

            modelBuilder.Entity<Empresa>(entity =>
            {
                entity.HasKey(e => e.IdEmpresa)
                    .HasName("PK__Empresa__5EF4033EAE317486");

                entity.ToTable("Empresa");

                entity.HasIndex(e => e.Cnpj, "UQ__Empresa__AA57D6B47A966B3B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Endereco>(entity =>
            {
                entity.HasKey(e => e.IdEndereco)
                    .HasName("PK__Endereco__0B7C7F1748BC9853");
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__Endereco__IdUsua__3D5E1FD2");
            });

            modelBuilder.Entity<Estagio>(entity =>
            {
                entity.HasKey(e => e.IdEstagio)
                    .HasName("PK__Estagio__C70AD76C1D2D0C23");
            ...
            modelBuilder.Entity<ExperienciaProfissional>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCandidatoNavigation)
                    ...
                    .HasConstraintName("FK__Experienc__IdCan__46E78A0C");
            });

            modelBuilder.Entity<Habilidade>(entity =>
            {
                entity.HasKey(e => e.IdHabilidade)
                    .HasName("PK__Habilida__0DD4B30D3424A9B4");
            ...
            modelBuilder.Entity<HabilidadeXcandidato>(entity =>
            {
                entity.HasKey(e => e.IdHabilidadeCandidato)
                    .HasName("PK__Habilida__F8880B5E52ED3DCF");
                ...
                entity.HasOne(d => d.IdCandidatoNavigation)
                    ...
                    .HasForeignKey(d => d.IdCandidato)
                    .HasConstraintName("FK__Habilidad__IdCan__4CA06362");

                entity.HasOne(d => d.IdHabilidadeNavigation)
                    .WithMany(p => p.HabilidadeXcandidatos)
                    .HasForeignKey(d => d.IdHabilidade)
                    .HasConstraintName("FK__Habilidad__IdHab__4BAC3F29");
            });

            modelBuilder.Entity<Inscricao>(entity =>
            {
                entity.HasKey(e => e.IdInscricao)
                    .HasName("PK__Inscrica__6209444B1C318835");
                ...
                entity.HasOne(d => d.IdCandidatoNavigation)
                    ...
                    .HasForeignKey(d => d.IdCandidato)
                    .HasConstraintName("FK__Inscricao__IdCan__693CA210");
            ...
            modelBuilder.Entity<NivelEscolaridade>(entity =>
            {
                entity.HasKey(e => e.IdNivelEscolaridade)
                    .HasName("PK__NivelEsc__8D47452714B2E2F1");
            ...
            modelBuilder.Entity<NivelVaga>(entity =>
            {
                entity.HasKey(e => e.IdNivelVaga)
                    .HasName("PK__NivelVag__465CED7E7F4536B3");
            ...
            modelBuilder.Entity<Requisito>(entity =>
            {
                entity.HasKey(e => e.IdRequisito)
                    .HasName("PK__Requisit__661FC7C2F3C25A0C");
            ...
            modelBuilder.Entity<RequisitoXvaga>(entity =>
            {
                entity.HasKey(e => e.IdRequisitoVaga)
                    .HasName("PK__Requisit__A350B0235C444AA1");
                ...
                entity.HasOne(d => d.IdRequisitoNavigation)
                    ...
                    .HasConstraintName("FK__Requisito__IdReq__619B8048");

                entity.HasOne(d => d.IdVagaNavigation)
                    .WithMany(p => p.RequisitoXvagas)
                    .HasForeignKey(d => d.IdVaga)
                    .HasConstraintName("FK__Requisito__IdVag__628FA481");
            });

            modelBuilder.Entity<StatusInscricao>(entity =>
            {
                entity.HasKey(e => e.IdStatusInscricao)
                    .HasName("PK__StatusIn__4F419FD76AD9456E");
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__TipoUsua__CA04062BC98A404B");
            ...
            modelBuilder.Entity<TipoVaga>(entity =>
            {
                entity.HasKey(e => e.IdTipoVaga)
                    .HasName("PK__TipoVaga__763461BC4617C6A8");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__Usuario__5B65BF97AED08D7C");

                entity.ToTable("Usuario");

                entity.HasIndex(e => e.Email, "UQ__Usuario__A9D105344264B2DD")
                    .IsUnique();
            ...
            modelBuilder.Entity<Vaga>(entity =>
            {
                entity.HasKey(e => e.IdVaga)
                    .HasName("PK__Vaga__A848DC3E7C892AD7");
                ...
                entity.HasOne(d => d.IdEmpresaNavigation)
                    ...
                    .HasConstraintName("FK__Vaga__IdEmpresa__5AEE82B9");

                entity.HasOne(d => d.IdNivelVagaNavigation)
                    .WithMany(p => p.Vagas)
                    .HasForeignKey(d => d.IdNivelVaga)
                    .HasConstraintName("FK__Vaga__IdNivelVag__5CD6CB2B");

                entity.HasOne(d => d.IdTipoVagaNavigation)
                    .WithMany(p => p.Vagas)
                    .HasForeignKey(d => d.IdTipoVaga)
                    .HasConstraintName("FK__Vaga__IdTipoVaga__5BE2A6F2");
            });
